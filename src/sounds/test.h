...
#define pattern0_data                                                          \
  {                                                                            \
    ATM_CMD_M_SET_VOLUME(0), ATM_CMD_M_DELAY_TICKS(32),                        \
        ATM_CMD_M_DELAY_TICKS(32), ATM_CMD_I_STOP,                             \
  }
DEFINE_PATTERN(pattern0_array, pattern0_data);

/* Pattern 1 ticks = 2048 / bytes = 6 */
#define pattern1_data                                                          \
  { ATM_CMD_M_SET_TEMPO(50), ATM_CMD_M_CALL_REPEAT(4, 4), ATM_CMD_I_STOP, }
DEFINE_PATTERN(pattern1_array, pattern1_data);

/* Pattern 2 ticks = 2048 / bytes = 5 */
#define pattern2_data                                                          \
  { ATM_CMD_M_CALL_REPEAT(6, 32), ATM_CMD_I_NOTE_OFF, ATM_CMD_I_STOP, }
DEFINE_PATTERN(pattern2_array, pattern2_data);

/* Pattern 3 ticks = 2048 / bytes = 7 */
#define pattern3_data                                                          \
  {                                                                            \
    ATM_CMD_I_STOP, ATM_CMD_M_CALL_REPEAT(0, 8), ATM_CMD_M_CALL_REPEAT(7, 24), \
        ATM_CMD_I_STOP,                                                        \
  }
...
#define pattern4_data                                                          \
  {                                                                            \
    ATM_CMD_M_CALL_REPEAT(5, 2), ATM_CMD_M_ADD_TRANSPOSITION(3),               \
        ATM_CMD_M_CALL_REPEAT(5, 2), ATM_CMD_M_ADD_TRANSPOSITION(-1),          \
        ATM_CMD_M_CALL_REPEAT(5, 2), ATM_CMD_M_ADD_TRANSPOSITION(3),           \
        ATM_CMD_M_CALL_REPEAT(5, 2), ATM_CMD_M_ADD_TRANSPOSITION(-5),          \
        ATM_CMD_I_RETURN,                                                      \
  }
...
#define pattern5_data                                                          \
  {                                                                            \
    ATM_CMD_I_NOTE_B5, ATM_CMD_M_SET_VOLUME(127), ATM_CMD_M_SLIDE_VOL_ON(-32), \
        ATM_CMD_M_DELAY_TICKS(16), ATM_CMD_M_SET_VOLUME(32),                   \
        ATM_CMD_M_SLIDE_VOL_ON(-8), ATM_CMD_M_DELAY_TICKS(4),                  \
        ATM_CMD_M_SLIDE_VOL_OFF, ATM_CMD_M_DELAY_TICKS(20),                    \
        ATM_CMD_M_DELAY_TICKS(24), ATM_CMD_I_RETURN,                           \
  }
...
#define pattern6_data                                                          \
  {                                                                            \
    ATM_CMD_I_NOTE_B2, ATM_CMD_M_SET_VOLUME(64), ATM_CMD_M_SLIDE_VOL_ON(-2),   \
        ATM_CMD_M_DELAY_TICKS(32), ATM_CMD_M_SLIDE_VOL_ON(2),                  \
        ATM_CMD_M_DELAY_TICKS(31), ATM_CMD_M_TREMOLO_OFF,                      \
        ATM_CMD_M_DELAY_TICKS(3), ATM_CMD_I_RETURN,                            \
  }
...
#define pattern7_data                                                          \
  {                                                                            \
    ATM_CMD_M_SET_VOLUME(64), ATM_CMD_M_DELAY_TICKS(2),                        \
        ATM_CMD_M_SET_VOLUME(0), ATM_CMD_M_DELAY_TICKS(16),                    \
                                                                               \
        ATM_CMD_M_SET_VOLUME(64), ATM_CMD_M_DELAY_TICKS(2),                    \
        ATM_CMD_M_SET_VOLUME(0), ATM_CMD_M_DELAY_TICKS(16),                    \
                                                                               \
        ATM_CMD_M_SET_VOLUME(64), ATM_CMD_M_SLIDE_VOL_ON(-4),                  \
        ATM_CMD_M_DELAY_TICKS(17), ATM_CMD_M_SLIDE_VOL_OFF,                    \
        ATM_CMD_M_DELAY_TICKS(17), ATM_CMD_I_RETURN,                           \
  }
